...
<table class="form_table">
	...
	<tr>
		...
		<td><input name="point_coverage" type="radio" id="point_coverage0" value="0"<?php if( WCUtils::is_zero( $this->options['point_coverage'] ) ) echo 'checked="checked"'; ?> /></td><td width="220"><label for="point_coverage0"><?php _e('Limited Only to Total Merchandise Price', 'usces'); ?></label></td>
	...
	<tr>
		<td><input name="point_coverage" type="radio" id="point_coverage1" value="1"<?php if( 1 == $this->options['point_coverage'] ) echo 'checked="checked"'; ?> /></td><td width="220"><label for="point_coverage1"><?php _e('Applicable to Total Merchandise Price and Handling Fee', 'usces'); ?></label></td>
	</tr>
</table>
<table class="form_table">
	<tr>
