...
<div id="uscestabs" class="usces_settlement" style="display:none;">
	...
	<ul>
		<li><a href="#uscestabs_settlement_top"><?php _e( 'Selecting a Settlement Module', 'usces' ); ?></a></li>
	...
	<form action="" method="post" id="settlement_top_form">
		<div class="settlement-left">
			<h2><?php _e( 'Available settlement modules', 'usces' ); ?></h2>
		...
		<div class="settlement-right">
			<div class="settlement-selected-header"><?php _e( 'Settlement modules in use', 'usces' ); ?></div>
		...
		<?php endif; ?>
			...
			<div class="settlement-selected-footer">
				...
				<input name="usces_option_update" type="submit" class="button button-primary" value="<?php _e( 'Update the modules to use', 'usces' ); ?>" />
