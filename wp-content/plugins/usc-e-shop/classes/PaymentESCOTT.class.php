...
<?php
	...
	public function settlement_update() {
		...
		$options['acting_settings']['escott']['card_key_aes'] = ( isset( $_POST['card_key_aes'] ) ) ? $_POST['card_key_aes'] : '';
		$options['acting_settings']['escott']['card_key_iv'] = ( isset( $_POST['card_key_iv'] ) ) ? $_POST['card_key_iv'] : '';
	...
	<form action="" method="post" name="escott_form" id="escott_form">
		...
		<table class="settle_table">
			...
			<tr class="card_escott card_sec3d_escott">
				<th><a class="explanation-label" id="label_ex_card_key_aes_escott"><?php _e( 'Encryption Key', 'usces' );//暗号化キー ?></a></th>
				<td><input name="card_key_aes" type="text" id="card_key_aes_escott" value="<?php echo $acting_opts['card_key_aes']; ?>" class="regular-text" /></td>
			</tr>
			<tr id="ex_card_key_aes_escott" class="explanation card_escott card_sec3d_escott"><td colspan="2"><?php _e( 'Encryption key (single-byte alphanumeric characters only) issued by e-SCOTT.', 'usces' ); ?><?php _e( 'If you want to use 3D Secure Authentication, please apply to Sony Payment Service Co., Ltd.', 'usces' ); ?></td></tr>
			<tr class="card_escott card_sec3d_escott">
				<th><a class="explanation-label" id="label_ex_card_key_iv_escott"><?php _e( 'Initialization Vector', 'usces' );//初期化ベクトル ?></a></th>
				<td><input name="card_key_iv" type="text" id="card_key_iv_escott" value="<?php echo $acting_opts['card_key_iv']; ?>" class="regular-text" /></td>
			</tr>
			<tr id="ex_card_key_iv_escott" class="explanation card_escott card_sec3d_escott"><td colspan="2"><?php _e( 'Initialization vector (single-byte alphanumeric characters only) issued by e-SCOTT.', 'usces' ); ?><?php _e( 'If you want to use 3D Secure Authentication, please apply to Sony Payment Service Co., Ltd.', 'usces' ); ?></td></tr>
			<tr class="card_escott">
